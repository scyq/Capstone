...
export function getDailyScale() {
	...
	const ifSharedAndReply = [{
		...
		},
		{
			...
			widgets: [{
				...
				{
					bold: '责怪、责骂或者惩罚我',
					nomal: '（例如： 威胁要惩罚我； 因为我如此情绪化而对我感到生气或愤怒；责骂我控制不好情绪；因为我感到如此情绪化而责骂我；斥责我没有把事情处理的更好；因为我情绪不好而责骂我）'
				}
			]
		},
		{
	...
	const ifShared = [{
		...
		{
			content: "请问，你为什么想要和ta分享你的心情和感受呢?",
			post: true
		},
		{
			content: "请详细地说说你和别人分享自己情绪的原因，例如你希望得到哪些支持、帮助或者建议？",
			type: "textfield"
		},
		{
			content: '可否从以下内容中选择最接近的？',
